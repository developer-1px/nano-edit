...
export interface DemoArtifactsAppHandle {
  destroy(): void
}

export function createDemoArtifactsApp(demoRoot: HTMLElement): DemoArtifactsAppHandle {
  ...
  const unsubscribeRouter = demoRouter.subscribe('onResolved', (event) => {
