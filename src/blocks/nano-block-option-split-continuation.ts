...
function attrsWithFootnoteContinuationIndents(
  ...
  if (footnoteContinuationIndents.length > 0) next.footnoteContinuationIndents = footnoteContinuationIndents
  else delete next.footnoteContinuationIndents
  return next
}
...
function attrsWithContinuationIndents(
  ...
  const next = { ...attrs }
  if (continuationIndents.length > 0) next.continuationIndents = continuationIndents
  else delete next.continuationIndents
  return next
}
