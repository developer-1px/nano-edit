...
test('Special searches narrow block index candidates', () => {
  const markdown = [
    '# Home',
    '',
    '- [ ] Todo #work',
...
test('Unknown localized @ searches stay literal terms', () => {
  ...
  assert.deepEqual(nanoDocumentSearch(document, '@읽는시간')?.blockIds, ['md-1'])
})
