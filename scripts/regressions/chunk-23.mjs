...
test('Markdown selected list blocks indent together with Markdown syntax', () => {
  const markdown = '- [ ] task\n  detail\n+ item\n  more'
...
test('Markdown list type changes keep raw marker and continuation indentation', () => {
...
test('Markdown source edit lifts list children when parent stops being a list block', () => {
