...
test('Todo checkbox keeps a measurable hit target', () => {
  ...
  assert(listRule[1].includes('grid-template-columns: 18px minmax(0, 1fr);'))
  ...
  assert(checkboxRule[1].includes('width: 18px;'))
  assert(checkboxRule[1].includes('height: 1.6em;'))
  ...
  assert(markerRule[1].includes('height: 1.6em;'))
