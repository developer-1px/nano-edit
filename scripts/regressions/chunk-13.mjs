...
test('Markdown images preserve Markdown title text', () => {
...
test('Markdown images preserve angle destinations with spaces and parentheses', () => {
...
test('Markdown images preserve explicit angle destination spelling', () => {
